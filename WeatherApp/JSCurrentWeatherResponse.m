...
#import "JSCurrentWeatherResponse.h"
#import "JSWind.h"
#import "JSClouds.h"
#import "JSCoord.h"
#import "JSWeather.h"
...
NSString *const kJSCurrentWeatherCod = @"cod";
...
@interface JSCurrentWeatherResponse ()

- (id)objectOrNilForKey:(id)aKey fromDictionary:(NSDictionary *)dict;

@end

@implementation JSCurrentWeatherResponse
...
- (instancetype)initWithDictionary:(NSDictionary *)dict
{
    ...
    if(self && [dict isKindOfClass:[NSDictionary class]]) {
            ...
            self.cod = [[self objectOrNilForKey:kJSCurrentWeatherCod fromDictionary:dict] doubleValue];
...
- (NSDictionary *)dictionaryRepresentation
{
    ...
    [mutableDict setValue:[NSNumber numberWithDouble:self.cod] forKey:kJSCurrentWeatherCod];
...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    self.cod = [aDecoder decodeDoubleForKey:kJSCurrentWeatherCod];
...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeDouble:_cod forKey:kJSCurrentWeatherCod];
...
{
    JSCurrentWeatherResponse *copy = [[JSCurrentWeatherResponse alloc] init];
